...
public class QuanLyHoaDonForm extends JFrame {
        ...
        public QuanLyHoaDonForm() {
            ...
            try {
                setIconImage(new ImageIcon(getClass().getResource("/images/invoice_icon.png")).getImage());
            } catch (Exception e) {
        ...
        private void onXemChiTietClicked() {
            ...
            try {
                ...
                // Create and display the detail dialog
    ...
    switch (trangThai) {
        ...
        private void generateReport() {
            SwingWorker<Boolean, Void> worker = new SwingWorker<Boolean, Void>() {
                ...
                protected Boolean doInBackground() throws Exception {
                    ...
                    if (fileChooser.showSaveDialog(QuanLyHoaDonForm.this) == JFileChooser.APPROVE_OPTION) {
                        File file = fileChooser.getSelectedFile();
        ...
        public static void main(String[] args) {
            ...
            SwingUtilities.invokeLater(() -> {
                QuanLyHoaDonForm form = new QuanLyHoaDonForm();

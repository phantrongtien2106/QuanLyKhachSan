...
public class HopDongQuanLyForm extends JFrame {
    ...
    private void xoaHopDong() {
        ...
        String trangThai = modelHopDong.getValueAt(selectedRow, 4).toString();

        // Kiểm tra nếu hợp đồng đang sử dụng hoặc đã thanh toán
    ...
    private void refreshData() {
        ...
        public static void main(String[] args) {
            ...
            java.awt.EventQueue.invokeLater(() -> {
                new HopDongQuanLyForm().setVisible(true);
            });
        }
}